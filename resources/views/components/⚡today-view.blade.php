                ...
                <div class="mt-8">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        @foreach($timeSlots as $slot)
                            <div class="border rounded-lg p-4 {{ $slot['booking'] ? 'bg-blue-50 border-blue-200' : 'bg-white border-gray-200' }}">
                                ...
                                @if($slot['booking'])
                                    <div class="text-sm space-y-1">
                                        @if($slot['booking']['service_name'])
                                            ...
                                            @endif
                                            <p class="text-gray-500 text-xs">{{ $slot['booking']['starts_at'] }} - {{ $slot['booking']['ends_at'] }}</p>
                                        @else
                                            <p class="text-gray-600 italic">Time blocked out</p>
                                            <button
                                                wire:click="unblockSlot({{ $slot['booking']['id'] }})"
                                                class="mt-2 w-full text-xs px-2 py-1 bg-red-100 text-red-700 rounded hover:bg-red-200 transition"
                                            >
                                                Unblock
                                            </button>
                                        @endif
                                ...
                                @else
                                    <button
                                        ...
                                        class="mt-2 w-full text-sm px-3 py-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition font-medium"
                                    >
                                        Block Out
                                    </button>
                                @endif
